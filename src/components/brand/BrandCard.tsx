...
export function BrandCard({ brand }: { brand: BrandInfo }) {
  return (
    <Link
      ...
      className="tap-scale lift-on-hover group flex flex-col items-center rounded-xl border border-border bg-white p-6 text-center hover:border-vbi-navy/20 hover:shadow-xl"
    >
